...
overloaded(const volatile int i)
{
  unscoped_var = i;
}

BOOST_SYMBOL_EXPORT void
overloaded(const double d)
{
  some_space::variable = d;
}

BOOST_SYMBOL_EXPORT void
use_variant(boost::variant<int, double>& v)
{
  v = 42;
}

BOOST_SYMBOL_EXPORT void
use_variant(boost::variant<double, int>& v)
{
  v = 3.124;
}
...
some_class&
some_class::operator=(some_class&& ref)
{
  return ref;
}
...
void
some_class::set_value(const int& i)
{
  value = i;
}

// some_class* some_class::dummy() {return new some_class();}//so it implements
// an allocating ctor.

double
some_class::func(double i, double j)
{
  this_ = this;
  return i * j;
}
int
some_class::func(int i, int j)
{
  this_ = this;
  return i + j;
}
int
some_class::func(int i, int j) volatile
{
  this_ = this;
  return i - j;
  ;
...
double
some_class::func(double i, double j) const volatile
{
  this_ = this;
  return i / j;
}
...
int
some_class::get() const
{
  this_ = this;
  return mem_val;
}
void
some_class::set(int i)
{
  this_ = this;
  mem_val = i;
}
