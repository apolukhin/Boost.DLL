...
void cpp_plugin_type_pasrser::type_test(int*) {}
void cpp_plugin_type_pasrser::type_test(const int*) {}
void cpp_plugin_type_pasrser::type_test(const volatile int*) {}
void cpp_plugin_type_pasrser::type_test(std::string*) {}
void cpp_plugin_type_pasrser::type_test(const std::string*) {}
void cpp_plugin_type_pasrser::type_test(const volatile std::string*) {}
void cpp_plugin_type_pasrser::type_test(const std::string&) {}
void cpp_plugin_type_pasrser::type_test(const test_template_class<>&) {}
void cpp_plugin_type_pasrser::type_test(const test_template_class<void(int)>&) {
}
void cpp_plugin_type_pasrser::type_test(const test_template_class<int>&) {}
void cpp_plugin_type_pasrser::type_test(
    const test_template_class<std::string>&) {}
void cpp_plugin_type_pasrser::type_test(
