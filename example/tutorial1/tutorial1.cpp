...
#include "../shared_lib_path.hpp" // contains dll_test::replace_with_full_path
...
int main(int argc, char* argv[]) {
    ...
    plugin = dll::import_alias<my_plugin_api>( // type of imported symbol is located between `<` and `>`
        lib_path / "my_plugin_sum"/*<-*/ << dll_test::replace_with_full_path(argv[1]) /*->*/,                     // path to the library and library name
