...
#   define BOOST_B2_LIBRARY_DECORATIONS BOOST_LIB_THREAD_OPT BOOST_LIB_RT_OPT
#elif defined(BOOST_AUTO_LINK_NOMANGLE)
#   define BOOST_B2_LIBRARY_DECORATIONS
#else
#   define BOOST_B2_LIBRARY_DECORATIONS  "-" BOOST_LIB_TOOLSET BOOST_LIB_THREAD_OPT BOOST_LIB_RT_OPT "-" BOOST_LIB_VERSION
#endif
